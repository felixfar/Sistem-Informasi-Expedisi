 ...
 * @author ArDhiye
 */
public class list_Customers extends javax.swing.JInternalFrame {
String data[]=new String [4];
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtCus, javax.swing.GroupLayout.PREFERRED_SIZE, 202, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSearchActionPerformed
        try{
            ...
            Connection koneksi=DriverManager.getConnection(urldb,user,password);
            //Query SQL dan Eksekuusinya
            String strSQL="SELECT namacustomer,alamat,kota,telp FROM t_customer where namacustomer like '%"+txtCus.getText()+"%'";
            Statement st = koneksi.createStatement();
            ResultSet rs = st.executeQuery(strSQL);
    ...
    public void Cetak(){
        ...
        String report ="C:\\Users\\ArDhiye\\Documents\\NetBeansProjects\\expedisi_04111055\\src\\expedisi_04111055\\report\\rCustomer.jrxml";
