 ...
 * @author ArDhiye
 */
public class list_Kapal extends javax.swing.JInternalFrame {
String data[]=new String [2];
    /**
     * Creates new form list_Kapal
     */
    public list_Kapal() {
        initComponents();
        ...
        Table(tblKapal,new int[]{120,120});
...
private void Table(javax.swing.JTable tb,int lebar[]){
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(28, 28, 28)
                        .addComponent(txtKapal, javax.swing.GroupLayout.PREFERRED_SIZE, 219, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(txtKapal, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jLabel1)))
                .addGap(9, 9, 9)
    ...
    private void btSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSearchActionPerformed
        try {
            ...
            Connection koneksi = DriverManager.getConnection(urldb, user, password);
            //Query SQL dan Eksekuusinya
            String strSQL = "SELECT namakapal,pelayaran FROM t_kapal where namakapal like '%" + txtKapal.getText() + "%'";
            Statement st = koneksi.createStatement();
            ResultSet rs = st.executeQuery(strSQL);
