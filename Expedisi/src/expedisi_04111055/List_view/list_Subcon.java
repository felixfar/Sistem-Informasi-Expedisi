 ...
 * @author ArDhiye
 */
public class list_Subcon extends javax.swing.JInternalFrame {
String data[]=new String [4];
    /**
     * Creates new form list_Subcon
     */
    public list_Subcon() {
        initComponents();
        ...
        Table(tblSubcon,new int[]{120,120,120,120});
    ...
    private void initComponents() {
        ...
        txtSubcon = new javax.swing.JTextField();

        setClosable(true);
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Daftar Subcon");

        jLabel1.setText("Nama Subcon");
        ...
        jScrollPane1.setViewportView(tblSubcon);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txtSubcon, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(43, 43, 43)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtSubcon, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btSearch)
                    .addComponent(jLabel1))
    ...
    private void btSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSearchActionPerformed
        try {
            ...
            Connection koneksi = DriverManager.getConnection(urldb, user, password);
            //Query SQL dan Eksekuusinya
            String strSQL = "SELECT namasubcon,alamat,kota,telp FROM t_subcon where namasubcon like '%" + txtSubcon.getText() + "%'";
            Statement st = koneksi.createStatement();
            ResultSet rs = st.executeQuery(strSQL);
...
private javax.swing.table.DefaultTableModel tblModel = getDefaultTabelModel();
    ...
    private javax.swing.JTextField txtSubcon;
