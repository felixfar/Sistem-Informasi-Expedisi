 ...
 * @author ArDhiye
 */
public class mAgendoor extends javax.swing.JInternalFrame {
String data[]=new String [4];
    /**
     * Creates new form mAgendoor
     */
    public mAgendoor() {
        initComponents();
        tblAgendoor.setModel(tblModel);
        Table(tblAgendoor,new int[]{120,150,120,120});
      try{
    ...
    private void initComponents() {
        ...
        txtNamAgen = new javax.swing.JTextField();
        ...
        jLabel1.setText("Daftar Agen Door");
        ...
        tblAgendoor.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblAgendoorMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tblAgendoor);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(txtNamAgen, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jLabel3)
...
// TODO add your handling code here:
    ...
    private void btsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btsimpanActionPerformed
        try {
            ...
            Statement st = koneksi.createStatement();
            String strSQL = "INSERT INTO t_agendoor (namaagen,alamat,kota,telp) values('" + txtNamAgen.getText() + "','" + txtAlamat.getText() + "','" + cmbKota.getSelectedItem() + "','" + txtTelp.getText() + "')";
            st.executeUpdate(strSQL);

            data[0] = txtNamAgen.getText();
    ...
    private void btGantiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGantiActionPerformed
        try {
            ...
            String strSQL = "update t_agendoor set namaagen='" + txtNamAgen.getText() + "',alamat='" + txtAlamat.getText() + "',kota='" + cmbKota.getSelectedItem() + "',kota='" + txtTelp.getText() + "'where namasubcon='" + txtNamAgen.getText() + "'";
            st.executeUpdate(strSQL);
    ...
    private void btHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btHapusActionPerformed
        try {
            ...
            String strSQL = "delete from t_agendoor where namaagen='" + txtNamAgen.getText() + "'";
            st.executeUpdate(strSQL);
            tblModel.removeRow(row);
    ...
    private void tblAgendoorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblAgendoorMouseClicked
if (evt.getClickCount() == 1) {
            Tampil();
        }         // TODO add your handling code here:
    }//GEN-LAST:event_tblAgendoorMouseClicked
    int row=0;
    public void Tampil(){
        row=tblAgendoor.getSelectedRow();
        txtNamAgen.setText(tblModel.getValueAt(row, 0).toString());
    ...
    private javax.swing.table.DefaultTableModel getDefaultTabelModel() {
        ...
        new Object[][] {},
        new String[] {"Nama Agen Door","Alamat","Kota","Telephone"}
         ){
    ...
    private javax.swing.JTextField txtNamAgen;
