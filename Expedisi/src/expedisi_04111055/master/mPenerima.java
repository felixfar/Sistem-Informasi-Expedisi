 ...
 * @author ArDhiye
 */
public class mPenerima extends javax.swing.JInternalFrame {
String data[]=new String[4];
    /**
     * Creates new form mPenerima
     */
    public mPenerima() {
        initComponents();
        tblPenerima.setModel(tblModel);
        Table(tblPenerima,new int[]{120,150,120,120});
        try{
    ...
    private void initComponents() {
        ...
        txtNamPer = new javax.swing.JTextField();
        ...
        jLabel1.setText("DAFTAR PENERIMA");
        ...
        jScrollPane2.setViewportView(tblPenerima);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(txtNamPer, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
...
// TODO add your handling code here:
    ...
    private void btsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btsimpanActionPerformed
        try {
            ...
            Statement st = koneksi.createStatement();
            String strSQL = "INSERT INTO t_penerima (namapenerima,alamat,kota,telp) values('" + txtNamPer.getText() + "','" + txtAlamat.getText() + "','" + cmbKota.getSelectedItem() + "','" + txtTelp.getText() + "')";
            st.executeUpdate(strSQL);

            data[0] = txtNamPer.getText();
    ...
    private void btGantiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGantiActionPerformed
        try {
            ...
            String strSQL = "update t_penerima set namapenerima='" + txtNamPer.getText() + "',alamat='" +txtAlamat.getText()+ "',kota='"+cmbKota.getSelectedItem()+"',kota='"+txtTelp.getText()+"'where namapenerima='" + txtNamPer.getText() + "'";
            st.executeUpdate(strSQL);
    ...
    private void btHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btHapusActionPerformed
        try {
            ...
            String strSQL = "delete from t_penerima where namapenerima='" + txtNamPer.getText() + "'";
            st.executeUpdate(strSQL);
            tblModel.removeRow(row);
...
if (evt.getClickCount() == 1) {
    ...
    int row=0;
    public void Tampil(){
        row=tblPenerima.getSelectedRow();
        txtNamPer.setText(tblModel.getValueAt(row, 0).toString());
    ...
    private javax.swing.JTextField txtNamPer;
